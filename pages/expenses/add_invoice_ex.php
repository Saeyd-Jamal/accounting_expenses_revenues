...
if(isset($_POST['add'])){
    ...
    $sql_add = "INSERT INTO `invoice_expenses` VALUES ('','$invoice_date',$invoice_amount,$center,$section,$company,'$statement','$send_society','$check_issue','$check_receipt','$cash_a_check','$budget_recording')";

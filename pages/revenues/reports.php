...
<head>
  ...
  <title>تقرير الواردات - إدراة المراكز الطبية - <?php echo $start_date_s; ?> -- <?php if($start_date_s != $end_date_s){ echo $end_date_s;}?></title>
</head>
<body>
<div  class="mx-1 d-flex flex-column align-items-center">
  <h1 class="fs-3 d-print-none" >تقرير الواردات</h1>

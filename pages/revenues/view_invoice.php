...
<?php
  ...
  if(isset($_POST['del_invoice'])){
    global $conn;
    $invoice_num = $_POST["invoice_num"];
    $sql_del = "DELETE FROM `invoice_revenues` WHERE `invoice_num` = $invoice_num";
    $del_invoice = mysqli_query($conn, $sql_del);
    header("location:view_invoice.php");
  }
?>
<h1 class="my-5 mx-1">فواتير الواردات</h1>
<section class="mx-1">
  <table class="table table-striped table-bordered">
    ...
    <?php
    global $conn;
    $sql_view = "SELECT * FROM `invoice_revenues`";
